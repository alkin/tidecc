...
logic/acceleration.obj: ../logic/acceleration.c $(GEN_OPTS) $(GEN_SRCS)
	...
	$(shell echo -O0 >> "logic/acceleration_ccsCompiler.opt")
...
logic/altitude.obj: ../logic/altitude.c $(GEN_OPTS) $(GEN_SRCS)
	...
	$(shell echo -O0 >> "logic/altitude_ccsCompiler.opt")
...
logic/battery.obj: ../logic/battery.c $(GEN_OPTS) $(GEN_SRCS)
	...
	$(shell echo -O0 >> "logic/battery_ccsCompiler.opt")
...
logic/bluerobin.obj: ../logic/bluerobin.c $(GEN_OPTS) $(GEN_SRCS)
	...
	$(shell echo -O0 >> "logic/bluerobin_ccsCompiler.opt")
...
logic/clock.obj: ../logic/clock.c $(GEN_OPTS) $(GEN_SRCS)
	...
	$(shell echo -O0 >> "logic/clock_ccsCompiler.opt")
...
logic/datalog.obj: ../logic/datalog.c $(GEN_OPTS) $(GEN_SRCS)
	...
	$(shell echo -O0 >> "logic/datalog_ccsCompiler.opt")
...
logic/date.obj: ../logic/date.c $(GEN_OPTS) $(GEN_SRCS)
	...
	$(shell echo -O0 >> "logic/date_ccsCompiler.opt")
...
logic/distance.obj: ../logic/distance.c $(GEN_OPTS) $(GEN_SRCS)
	...
	$(shell echo -O0 >> "logic/distance_ccsCompiler.opt")
...
logic/light.obj: ../logic/light.c $(GEN_OPTS) $(GEN_SRCS)
	...
	$(shell echo -O0 >> "logic/light_ccsCompiler.opt")
...
logic/menu.obj: ../logic/menu.c $(GEN_OPTS) $(GEN_SRCS)
	...
	$(shell echo -O0 >> "logic/menu_ccsCompiler.opt")
...
logic/rfbike.obj: ../logic/rfbike.c $(GEN_OPTS) $(GEN_SRCS)
	...
	$(shell echo -O0 >> "logic/rfbike_ccsCompiler.opt")
...
logic/rfsimpliciti.obj: ../logic/rfsimpliciti.c $(GEN_OPTS) $(GEN_SRCS)
	...
	$(shell echo -O0 >> "logic/rfsimpliciti_ccsCompiler.opt")
...
logic/sensor.obj: ../logic/sensor.c $(GEN_OPTS) $(GEN_SRCS)
	...
	$(shell echo -O0 >> "logic/sensor_ccsCompiler.opt")
...
logic/speed.obj: ../logic/speed.c $(GEN_OPTS) $(GEN_SRCS)
	...
	$(shell echo -O0 >> "logic/speed_ccsCompiler.opt")
...
logic/temperature.obj: ../logic/temperature.c $(GEN_OPTS) $(GEN_SRCS)
	...
	$(shell echo -O0 >> "logic/temperature_ccsCompiler.opt")
...
logic/user.obj: ../logic/user.c $(GEN_OPTS) $(GEN_SRCS)
	...
	$(shell echo -O0 >> "logic/user_ccsCompiler.opt")
